...
public class DistributedCache : IDistributedCache
{
	...
	private static readonly string[] _hashMembersAbsoluteExpirationSlidingExpirationData =
		new string[] { AbsoluteExpirationKey, SlidingExpirationKey, DataKey };

	private static readonly string[] _hashMembersAbsoluteExpirationSlidingExpiration =
		new string[] { AbsoluteExpirationKey, SlidingExpirationKey };
	...
	public void Set(string key, byte[] value, DistributedCacheEntryOptions options)
	{
		...
		_redisClient.Eval(SetScript, new[] { key },
			new object[]
			{
				absoluteExpiration?.Ticks ?? NotPresent, options.SlidingExpiration?.Ticks ?? NotPresent,
				GetExpirationInSeconds(creationTime, absoluteExpiration, options) ?? NotPresent, value
			});
	}
