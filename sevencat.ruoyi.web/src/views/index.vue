	...
	<div class="home">
		<section class="hero-panel">
			<div class="hero-copy">
				...
				<p>
					企业级后台管理系统 重写 RuoYi-Vue 所有功能 集成
					Sa-Token、Mybatis-Plus、WarmFlow、SpringDoc、Hutool、OSS 等组件
				</p>
				<div class="hero-actions">
					<el-button type="primary" @click="goTarget('https://gitee.com/dromara/RuoYi-Vue-Plus')">
						查看源码
					</el-button>
...
html.dark {
	.hero-panel {
		background:
			radial-gradient(circle at top left, rgba(53, 109, 255, 0.18), transparent 30%), var(--app-surface-bg);
	}
}
</style>
